...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBeanMath() {
        ...
        // 验证码文本生成器(KaptchaTextCreator的包名)
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.yhz.senbeiforummain.util.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2
        ...
        properties.setProperty(KAPTCHA_BACKGROUND_CLR_FROM, "lightGray");
